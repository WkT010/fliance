...
var OrderPool = sync.Pool{New: func() interface{} {
	return &Order{Price: newBigFloat(), Quantity: newBigFloat(), FilledQty: newBigFloat(), RemainingQty: newBigFloat()}
}}
...
func GetOrder() *Order {
	...
	o.Price.SetFloat64(0)
	o.Quantity.SetFloat64(0)
	o.FilledQty.SetFloat64(0)
	o.RemainingQty.SetFloat64(0)
	return o
}
...
func GetTrade() *Trade {
	...
	t.Price.SetFloat64(0)
	t.Quantity.SetFloat64(0)
	t.Fee.SetFloat64(0)
	return t
}
